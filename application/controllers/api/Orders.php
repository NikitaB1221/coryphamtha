...
class Orders extends CI_Controller {
    ...
    public function update($id) {
        ...
        $this->Orders_model->update_order($id, $data);
    ...
    public function get_cart_items_by_user_id($user_id) {
        $cart_items = $this->Orders_model->get_cart_items_by_user_id($user_id);
        echo json_encode($cart_items);
    }
    //public function calculate_total_price($user_id) {
    //    $cart_items = $this->Orders_model->get_cart_items_by_user_id($user_id);
    //    $total_price = $this->Orders_model->calculate_total_price($cart_items);
